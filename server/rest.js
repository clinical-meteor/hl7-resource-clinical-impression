...
JsonRoutes.add("get", "/fhir/ClinicalImpression", function (req, res, next) {
  ...
  // console.log('GET /fhir/ClinicalImpression', req.query);
  ...
  if (accessToken || process.env.NOAUTH) {
    ...
    process.env.DEBUG && console.log('ClinicalImpressions.find(id)', ClinicalImpressions.find(databaseQuery).fetch());
    ...
    clinicalImpressionData.forEach(function(patient){
